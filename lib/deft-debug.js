...
Copyright (c) 2012-2015 [DeftJS Framework Contributors](http://deftjs.org)
    ...
    resolve: function(targetInstance, targetInstanceConstructorArguments) {
        ...
        if (this.getFn() != null) {
            ...
            if (targetInstanceConstructorArguments) {
                fnArguments = [
                    targetInstance
                ].concat(Ext.toArray(targetInstanceConstructorArguments));
            } else {
                fnArguments = [
                    targetInstance
                ];
    ...
    inject: function(identifiers, targetInstance, targetInstanceConstructorArguments, targetInstanceIsInitialized) {
        ...
        if (targetInstanceIsInitialized) {
            ...
            targetInstance.initConfig = function(config) {
                var result;
                result = originalInitConfigFunction.call(this, Ext.apply(config || {}, injectConfig));
                return result;
            };
        }
...
Ext.define('Deft.mixin.Injectable', {
    ...
    onCreate: function() {
        ...
        objectifyInject = function(Class) {
            var i, id, inject, injectBase, injectObject, len;
            if (!Class) {
                return {};
            ...
            if (Ext.isArray(inject)) {
                injectObject = {};
                for (i = 0 , len = inject.length; i < len; i++) {
                    id = inject[i];
                    injectObject[id] = id;
                }
                inject = injectObject;
   ...
   */
     ...
     */
        propertyMergeHandler: function(originalParentObserve, originalChildObserve) {
            var childEvent, childEvents, childHandler, childHandlerArray, childObserve, childTarget, eventOptionNames, parentEvent, parentEvents, parentHandler, parentHandlerArray, parentObserve, parentTarget, ref, ref1;
                ...
                if (Ext.isArray(observeEvents)) {
                    ...
                    for (i = 0 , len = observeEvents.length; i < len; i++) {
                        ...
                        if (Ext.Object.getSize(thisObserveEvent) === 1) {
                            ...
                            newObserveEvents[thisObserveEvent.event] = [
                                handlerConfig
                            ];
                        }
                    }
...
Ext.define('Deft.mvc.ComponentSelector', {
    ...
    constructor: function(config) {
        ...
        Ext.apply(this, config);
        if (!this.live) {
            this.components = this.selector != null ? Ext.ComponentQuery.query(this.selector, this.view) : [
                this.view
            ];
        }
...
Ext.define('Deft.mvc.Observer', {
   ...
   */
    isTargetObservable: function(host, target) {
        ...
        if ((hostTarget.isObservable != null) || (hostTarget.isUtilObservable != null) || hostTarget.mixinId === "observable" || (((ref = hostTarget.mixins) != null ? ref.observable : void 0) != null)) {
            return true;
        } else {
...
Ext.define('Deft.mvc.ViewController', {
   ...
   */
    createCompanions: function() {
        var alias, clazz, ref, results;
        this.companionInstances = {};
        ref = this.companions;
        results = [];
        for (alias in ref) {
            clazz = ref[alias];
            results.push(this.addCompanion(alias, clazz));
        }
        return results;
    },
    /**
   ...
   */
    destroyCompanions: function() {
        var alias, instance, ref, results;
        ref = this.companionInstances;
        results = [];
        for (alias in ref) {
            instance = ref[alias];
            results.push(this.removeCompanion(alias));
        }
        return results;
    },
    /**
   ...
   */
    addCompanion: function(alias, clazz) {
        var error, error1, initialClass, isRecursionStart, newHost, stackMessage;
   ...
   */
    removeCompanion: function(alias) {
        ...
        try {
            if ((ref = this.companionInstances[alias]) != null) {
                ref.destroy();
            }
   ...
   */
    ...
    CallbackQueue = (function() {
        function CallbackQueue() {
            ...
            queuedCallbacks = new Array(10000);
...
Ext.define('Deft.promise.Resolver', {
   ...
   */
    resolve: function(value) {
        var error, error1, error2, isHandled, self, thenFn;
        if (this.completed) {
            return;
        }
        try {
